...
def main() -> int:
    ...
    with sync_playwright() as playwright:
        ...
        keyboard_page.keyboard.type("round8kbd12")
        keyboard_page.keyboard.press("Tab")
        keyboard_page.keyboard.press("Enter")
        ...
        page.get_by_label("密码").fill("round8pass12")
        ...
        second_page.get_by_label("密码").fill("round8scope1")
        ...
        page.get_by_label("密码").fill("round8scope1")
